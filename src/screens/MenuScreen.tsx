          ...
          <div style={{ marginTop: 36, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24, width: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                <a href="https://github.com/anhdaipro/chem-bubble-shooter/releases/download/chem-bubble-shooter/Chem.Bubble.Shooter.Setup.1.0.1.exe" target="_blank" rel="noreferrer" style={styles.downloadBtn}>
                  🪟 Windows
                </a>
                ...
                <a href="https://github.com/anhdaipro/chem-bubble-shooter/releases/download/chem-bubble-shooter/Chem.Bubble.Shooter-1.0.2-arm64.dmg" target="_blank" rel="noreferrer" style={styles.downloadBtn}>
                  🍎 macOS
                </a>
              </div>
            </div>
