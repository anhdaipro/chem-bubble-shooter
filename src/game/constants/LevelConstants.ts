...
export const ION_LEVELS: LevelConfig[] = [
  { id: 1, title: 'The Neutralizer', rows: 4, chemicals: ['Ag+', 'H+', 'CO32-', 'OH-', 'S2-'], speedMultiplier: 1.2, targetScore: 20000 },
  { id: 2, title: 'Heavy Shells', rows: 4, chemicals: ['Pb2+', 'Ca2+', 'CO32-', 'PO43-', 'S2-'], speedMultiplier: 1.4, targetScore: 40000 },
  { id: 3, title: 'Copper Iodide', rows: 4, chemicals: ['Pb2+', 'Cu2+', 'OH-', 'I-', 'SO32-'], speedMultiplier: 1.6, targetScore: 60000 },
  { id: 4, title: 'Iron-Copper Quest', rows: 4, chemicals: ['Ni2+', 'Fe2+', 'CO32-', 'PO43-', 'S2-'], speedMultiplier: 1.8, targetScore: 80000 },
  { id: 5, title: 'Magnesium Core', rows: 4, chemicals: ['Mn2+', 'Mg2+', 'CO32-', 'PO43-', 'S2-'], speedMultiplier: 1.8, targetScore: 100000 },
  { id: 6, title: 'Amphoteric Base', rows: 4, chemicals: ['Zn2+', 'Cr3+', 'CO32-', 'OH-', 'PO43-'], speedMultiplier: 2.0, targetScore: 120000 },
  { id: 7, title: 'Halogen Trap', rows: 4, chemicals: ['Ag+', 'Pb2+', 'Br-', 'I-', 'Cl-'], speedMultiplier: 2.0, targetScore: 140000 },
  { id: 8, title: 'Barium & Ammonia', rows: 4, chemicals: ['Ba2+', 'NH4+', 'SO42-', 'CO32-', 'OH-'], speedMultiplier: 2.0, targetScore: 160000 },
  { id: 9, title: 'Silver Silicate', rows: 4, chemicals: ['Ag+', 'Ba2+', 'PO43-', 'SO32-'], speedMultiplier: 2.0, targetScore: 180000 },
  { id: 10, title: 'Ferric Silicate', rows: 4, chemicals: ['Mn2+', 'Fe3+', 'OH-', 'SO32-', 'CrO42-'], speedMultiplier: 2.0, targetScore: 200000 },
  { id: 11, title: 'Active Sulfides', rows: 4, chemicals: ['Zn2+', 'Al3+', 'S2-', 'SO32-', 'CrO42-'], speedMultiplier: 2.0, targetScore: 220000 },
  { id: 12, title: 'Acidic Hard Water', rows: 4, chemicals: ['Ca2+', 'Mg2+', 'H+', 'SO32-', 'OH-'], speedMultiplier: 2.0, targetScore: 240000 },
...
export const METAL_LEVELS: LevelConfig[] = [
  { id: 1, title: 'Warm Up', rows: 4, chemicals: ['Mg', 'Zn', 'Al3+', 'Fe2+'], speedMultiplier: 1.1, targetScore: 15000 },
